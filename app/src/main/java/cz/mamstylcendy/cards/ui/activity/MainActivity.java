...
public class MainActivity extends AppCompatActivity implements WlanFencingManager.OnNearbyProviderCallback, PersonalCardStore.Listener {
    ...
    private CardsConfig.ProviderInfo showingProviderInfo = null;
    ...
    private void fakeShowProviderInfo(CardsConfig.ProviderInfo providerInfo) {
    ...
    private void showCard(CardRequest card) {
        ...
        CardsConfig.ProviderInfo pi = card.getProviderInfo();
    ...
    private static interface CardRequest {
        ...
        public CardsConfig.ProviderInfo getProviderInfo();
