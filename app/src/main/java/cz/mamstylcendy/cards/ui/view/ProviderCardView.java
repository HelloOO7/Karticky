...
import cz.mamstylcendy.cards.databinding.ProviderCardBinding;
...
public class ProviderCardView extends FrameLayout {
    ...
    public void setProvider(String providerId, CardsConfig.ProviderInfo providerInfo) {
    ...
    public void setActionButtonVisibility(int visibility) {
        binding.btnActionButton.setVisibility(visibility);
    }
